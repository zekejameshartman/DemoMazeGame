...
namespace DemoMazeGame.Services
{
    ...
    {
        void StartSession(string modelId, string modelName, bool showCoordinates, bool showAsciiMap, int delayBetweenMoves, bool distanceToWall, bool showGoalCoordinates, int maxRevisitsPerCell, int maxMoves, bool reasoningEnabled = true, string reasoningEffort = "medium", int? reasoningMaxTokens = null);
