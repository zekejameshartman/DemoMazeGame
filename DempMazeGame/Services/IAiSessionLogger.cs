...
namespace DemoMazeGame.Services
{
    ...
    {
        void StartSession(string modelId, string modelName, bool showCoordinates, bool showAsciiMap, int delayBetweenMoves, bool distanceToWall, bool showGoalCoordinates, bool breadcrumbs, int maxRevisitsPerCell, int maxMoves, bool reasoningEnabled = true, string reasoningEffort = "medium", int? reasoningMaxTokens = null);
        ...
        void EndSession(bool won, bool stoppedByUser, bool reachedMaxMoves, bool tooManyRevisits, bool errorOccurred, string? errorMessage = null);
    }
}
